...
@Component({
  ...
  styles: [`
    ...
    .role-name { font-size: 1.15rem; font-weight: 800; color: #12271f; }
    ...
    .perm-item { background: #f8fbf9; border: 1px solid #e3ebe6; border-radius: 8px; padding: 8px 12px; transition: var(--transition); }
    .perm-item:hover { background: #eef7f2; border-color: #c7e6d7; }
    ...
    .perm-name { font-size: 0.85rem; font-weight: 600; color: #12271f; }
